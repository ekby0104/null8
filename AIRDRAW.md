...
| 컨트롤 | 동작 |
|---|---|
| 색 스와치 5개 | `#ffffff` `#e8a33d` `#4ad6c8` `#e85d9e` `#a8e84d` |
...
## 13. 미해결 설계 노트 (구현하면서 결정)

- **핀치 프레이밍과의 충돌**: 현재 앱은 양손 핀치로 이펙트 프레임을 만든다.
  낙서와 공존 규칙(안): **한 손만 핀치 = 그리기**, **양손 동시 핀치 =
  프레임 제스처(그리기 중단)**. A2에서 확정.
