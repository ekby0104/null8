...
`;let I=null,Q=null,Mt=null,Ft=null,Dt=null,It=null;function Dn(t){const e=I;e.viewport(0,0,e.drawingBufferWidth,e.drawingBufferHeight),e.useProgram(Q),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,t.videoTex),e.uniform1i(Mt,0),e.uniform2f(Ft,1/t.video.videoWidth,1/t.video.videoHeight),e.uniform1f(Dt,t.time),e.uniform1i(It,t.mirror?1:0),K(e)}let Pe,X=null,ze,me=new Float32Array(0),Me=null;function In(t){const{width:e,height:n,data:o}=t.sample;X||(X=document.createElement("canvas"),ze=X.getContext("2d")),(X.width!==e||X.height!==n)&&(X.width=e,X.height=n,me=new Float32Array(e*n),Me=ze.createImageData(e,n));for(let a=0,c=0;a<e*n;a++,c+=4)me[a]=ue(o[c],o[c+1],o[c+2])/255;const i=Me.data;for(let a=0;a<n;a++)for(let c=0;c<e;c++){let s=0;c>0&&c<e-1&&a>0&&a<n-1&&(s=me[(a-1)*e+(c-1)]-me[(a+1)*e+(c+1)]);const u=(a*e+c)*4;i[u]=Math.min(255,Math.max(0,248-s*2.3*255)),i[u+1]=Math.min(255,Math.max(0,247-s*1.6*255)),i[u+2]=Math.min(255,Math.max(0,242-s*2.9*255)),i[u+3]=255}ze.putImageData(Me,0,0);const{width:r,height:l}=Pe.canvas;Pe.imageSmoothingEnabled=!0,Pe.drawImage(X,0,0,r,l)}const $n={id:"relief",name:"RELIEF",usesGl:!0,init(t,e){I=t,Pe=e,I&&!Q&&(Q=N(I,Fn),Mt=I.getUniformLocation(Q,"u_video"),Ft=I.getUniformLocation(Q,"u_texel"),Dt=I.getUniformLocation(Q,"u_time"),It=I.getUniformLocation(Q,"u_mirror"))},render(t){I&&t.videoTex?Dn(t):In(t)},dispose(){me=new Float32Array(0),Me=null}},Bn=`#version 300 es
...
`;let Y=null,ie=null,Xt=null,Ht=null,kt=null;function Wn(t){const e=Y;e.viewport(0,0,e.drawingBufferWidth,e.drawingBufferHeight),e.useProgram(ie),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,t.videoTex),e.uniform1i(Xt,0),e.uniform1f(Ht,t.time),e.uniform1i(kt,t.mirror?1:0),K(e)}const Vn=[[10,107,31],[51,168,61],[237,230,133],[250,250,240]];let pe,k=null,Ze,De=null;function qn(t){const{width:e,height:n,data:o}=t.sample;k||(k=document.createElement("canvas"),Ze=k.getContext("2d")),(k.width!==e||k.height!==n)&&(k.width=e,k.height=n,De=Ze.createImageData(e,n));const i=De.data;for(let a=0;a<n;a++)for(let c=0;c<e;c++){const s=(a*e+c)*4,u=(Math.random()-.5)*.16,m=ue(o[s],o[s+1],o[s+2])/255+u,f=Vn[m<.3?0:m<.52?1:m<.72?2:3];i[s]=f[0],i[s+1]=f[1],i[s+2]=f[2],i[s+3]=255}Ze.putImageData(De,0,0);const{width:r,height:l}=pe.canvas;pe.imageSmoothingEnabled=!1,pe.drawImage(k,0,0,r,l),pe.imageSmoothingEnabled=!0}const Yn={id:"riso",name:"RISO",usesGl:!0,init(t,e){Y=t,pe=e,Y&&!ie&&(ie=N(Y,kn),Xt=Y.getUniformLocation(ie,"u_video"),Ht=Y.getUniformLocation(ie,"u_time"),kt=Y.getUniformLocation(ie,"u_mirror"))},render(t){Y&&t.videoTex?Wn(t):qn(t)},dispose(){De=null}},jn=`#version 300 es
...
`;let Xe=!1,A=null,G=null,Qt=null,Jt=null,en=null,tn=null,nn=null,on=null;function no(t){const e=A,n=e.drawingBufferWidth,o=e.drawingBufferHeight;e.viewport(0,0,n,o),e.useProgram(G),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,t.videoTex),e.uniform1i(Qt,0),e.uniform2f(Jt,n,o),e.uniform1f(en,Math.max(1,Math.min(2,window.devicePixelRatio||1))),e.uniform1f(tn,t.time),e.uniform1i(nn,t.mirror?1:0),e.uniform1i(on,Xe?1:0),K(e)}const oo=[[0,8,2,10],[12,4,14,6],[3,11,1,9],[15,7,13,5]].map(t=>t.map(e=>(e+.5)/16)),ro={r:238,g:244,b:250},io={r:22,g:72,b:158},ao=.12;let ge,W=null,et,Ie=null;function lo(t){const{width:e,height:n,data:o}=t.sample;W||(W=document.createElement("canvas"),et=W.getContext("2d")),(W.width!==e||W.height!==n)&&(W.width=e,W.height=n,Ie=et.createImageData(e,n));const i=Ie.data;for(let a=0;a<n;a++){const c=oo[a&3];for(let s=0;s<e;s++){const u=(a*e+s)*4;let f=ue(o[u],o[u+1],o[u+2])/255+(Math.random()-.5)*ao>c[s&3];Xe&&(f=!f);const h=f?ro:io;i[u]=h.r,i[u+1]=h.g,i[u+2]=h.b,i[u+3]=255}}et.putImageData(Ie,0,0);const{width:r,height:l}=ge.canvas;ge.imageSmoothingEnabled=!1,ge.drawImage(W,0,0,r,l),ge.imageSmoothingEnabled=!0}const co={id:"blueprint",name:"BLUEPRINT",usesGl:!0,init(t,e){A=t,ge=e,A&&!G&&(G=N(A,to),Qt=A.getUniformLocation(G,"u_video"),Jt=A.getUniformLocation(G,"u_res"),en=A.getUniformLocation(G,"u_cell"),tn=A.getUniformLocation(G,"u_time"),nn=A.getUniformLocation(G,"u_mirror"),on=A.getUniformLocation(G,"u_invert"))},render(t){A&&t.videoTex?no(t):lo(t)},dispose(){Ie=null},onReselect(){Xe=!Xe}},so=`#version 300 es
